...
import edu.eci.arsw.beatApp.services.CarServices;
...
public class CarServicesImpl implements CarServices {
    ...
    @Override
    public List<Car> getAllCars() throws BeatAppApplicationPersistenceException {
        return carRepository.findAll();
    }

    @Override
    public void saveCar(Car car) throws BeatAppApplicationPersistenceException{
     ...
     */
    @Override
    public Car findCarByPlate(String plate) throws BeatAppApplicationPersistenceException {
        Optional<Car> optionalCar = carRepository.findByPlate(plate);
        if (!optionalCar.isPresent())
            throw new BeatAppApplicationPersistenceException(BeatAppApplicationPersistenceException.CAR_NOT_FOUND);
